	...
	<body>
		...
		<div id="subheader">
			<div id="innersubheader">
				...
				<span class="<?php echo ($s == 'property' ? 'subtab_active' : 'subtab') ?>" id="property">
					Property
				</span>
				...
				<span class="<?php echo ($s == 'voids' ? 'subtab_active' : 'subtab') ?>" id="voids">
					Voids
				</span>
			</div>
		</div>
			...
			foreach ($tenants2 as $tenantid => $tenant) {
				...
				foreach ($tenant as $tenancyid => $tenancy) {
					if ($tenancyid !== 'info') {
						...
						while ($duedate <= $t['enddate'] && $duedate <= '2016-06-09' ) { 	// ****** 31 MAY
